...
## 输出文件
out_OASIS3_file = 'new_predicts/ResNet/CA/OASIS3.xls'
out_AIBL_file = 'new_predicts/ResNet/CA/AIBL.xls'
out_ADNI_file = 'new_predicts/ResNet/CA/ADNI.xls'
## 分类模型
CNN = my_model_CNN_single((160,192,160,1))
VGG = VGG16((160,192,160,1))
ResNet =  Resnet((160,192,160,1))
GooleNet = Googlenet((160,192,160,1))
MHCNN = my_model_single((160,192,160,1))
## 加载权重
cnn = CNN.load_weights('',by_name=True)
vgg = VGG.load_weights('',by_name=True)
resnet = ResNet.load_weights('',by_name=True)
googlenet = GooleNet.load_weights('',by_name=True)
mhcnn = MHCNN.load_weights('',by_name=True)
