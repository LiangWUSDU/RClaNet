...
weights_path = "new_weights/CA/GoogleNet/"
weights_file = open('new_weights/CA/GoogleNet/weights.txt')
weights_strings = weights_file.readlines()
## 输出文件
out_OASIS3_file = 'new_predicts/GoogleNet/CA/OASIS3.xls'
out_AIBL_file = 'new_predicts/GoogleNet/CA/AIBL.xls'
out_ADNI_file = 'new_predicts/GoogleNet/CA/ADNI.xls'
##
