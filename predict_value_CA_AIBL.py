...
#model.load_weights('new_weights/CA/ResNet/weights.13-0.0312.hdf5',by_name=True)
##GoogleNet
#from networks.GoogleNet import Googlenet
#model = Googlenet((160,192,160,1))
#model.load_weights('new_weights/CA/GoogleNet/weights.09-0.1012.hdf5',by_name=True)
##MHCNN
