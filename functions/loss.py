...
def my_classification_loss(y_true, y_pred):
    loss1 = K.mean(K.binary_crossentropy(y_true[...,0], y_pred[...,0]), axis=-1)
    loss2 = K.mean(K.binary_crossentropy(y_true[...,1], y_pred[...,1]), axis=-1)
    loss3 = K.mean(K.binary_crossentropy(y_true[...,2], y_pred[...,2]), axis=-1)
    return loss1+5*loss2+2*loss3
