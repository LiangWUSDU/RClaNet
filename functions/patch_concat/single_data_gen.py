...
def vols_mask_generator_patch(vol_name, patch_size, stride_patch, out=1, num_images=27):
	# 120 = number of patches for one volume
	vol_patch = np.empty([num_images, 64, 64, 64, 4])
	# vol_patch = []
	vol_patch2 = []
	patch_loc = []
	count = 0  # count the batch size for the network
...
def vols_location_generator_patch(vol_name,  patch_size, stride_patch, out=1, num_images=27):
	# 120 = number of patches for one volume
	vol_patch = np.empty([num_images, 64, 64, 64, 3])
	# vol_patch = []
	vol_patch2 = []
	patch_loc = []
	count = 0  # count the batch size for the network
