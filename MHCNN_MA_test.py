...
weights_path = "new_weights/MA/MHCNN/"
weights_file = open('new_weights/MA/MHCNN/weights.txt')
weights_strings = weights_file.readlines()
## 输出文件
out_OASIS3_file = 'new_predicts/MHCNN/MA/OASIS3.xls'
out_AIBL_file = 'new_predicts/MHCNN/MA/AIBL.xls'
out_ADNI_file = 'new_predicts/MHCNN/MA/ADNI.xls'
##
