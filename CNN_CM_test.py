...
weights_path = "new_weights/CM/CNN/"
weights_file = open('new_weights/CM/CNN/weights.txt')
weights_strings = weights_file.readlines()
## 输出文件
out_OASIS3_file = 'new_predicts/CNN/CM/OASIS3.xls'
out_AIBL_file = 'new_predicts/CNN/CM/AIBL.xls'
out_ADNI_file = 'new_predicts/CNN/CM/ADNI.xls'
##
