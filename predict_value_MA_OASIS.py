...
#model.load_weights('new_weights/MA/GoogleNet/weights.10-0.1222.hdf5',by_name=True)
##MHCNN
from networks.my_model import my_model_single
model = my_model_single((160,192,160,1))
model.load_weights('new_weights/MA/MHCNN/weights.10-0.0322.hdf5',by_name=True)
import json
import xlwt
# 设置Excel编码
...
for id in range(len(OASIS3_strings)):
	...
	#sheet1.write(id, 1, np.float(OASIS3_task[id]))
