...
def find_position(x,value):
    ...
    p = np.array(p)
    return p
weight_dir = "new_weights/CA/MHCNN/"
...
myGene = my_gen(train_risk_file,train_txt,train_CDR,p_C,p_A,batch_size=batch_size)
##
...
test_epoch = (test_CN_num + test_AD_num)/batch_size
my_validGene = my_gen(test_ADNI_risk_file,test_txt,test_CDR,p_test_C,p_test_A,batch_size=batch_size)
