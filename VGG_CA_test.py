...
weights_path = "new_weights/CA/VGG/"
weights_file = open('new_weights/CA/VGG/weights.txt')
weights_strings = weights_file.readlines()
## 输出文件
out_OASIS3_file = 'new_predicts/VGG/CA/OASIS3.xls'
out_AIBL_file = 'new_predicts/VGG/CA/AIBL.xls'
out_ADNI_file = 'new_predicts/VGG/CA/ADNI.xls'
##
