...
from generators.gen_T1 import my_gen32
from networks.MultiHeadsModel import mutilheadattModel,MLP
from networks.my_model import my_model3_CNN
from functions.loss import focal_loss
...
def find_position(x,value):
    ...
    p = np.array(p)
    return p
weight_dir = "weights/all/my_model_CNN_T1_risk/"
...
myGene = my_gen32(train_image_file,train_risk_file,train_txt,train_CDR,batch_size=batch_size)
##
...
my_validGene = my_gen32(test_ADNI_image_file,test_ADNI_risk_file,test_txt,test_CDR,batch_size=batch_size)

model =  my_model3_CNN((160,192,160,1))
#model.summary()
