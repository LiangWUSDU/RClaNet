...
weights_path = "new_weights/MA/CNN/"
weights_file = open('new_weights/MA/CNN/weights.txt')
weights_strings = weights_file.readlines()
## 输出文件
out_OASIS3_file = 'new_predicts/CNN/MA/OASIS3.xls'
out_AIBL_file = 'new_predicts/CNN/MA/AIBL.xls'
out_ADNI_file = 'new_predicts/CNN/MA/ADNI.xls'
##
