...
weights_path = "new_weights/CM/MHCNN/"
weights_file = open('new_weights/CM/MHCNN/weights.txt')
weights_strings = weights_file.readlines()
## 输出文件
out_OASIS3_file = 'new_predicts/MHCNN/CM/OASIS3.xls'
out_AIBL_file = 'new_predicts/MHCNN/CM/AIBL.xls'
out_ADNI_file = 'new_predicts/MHCNN/CM/ADNI.xls'
##
