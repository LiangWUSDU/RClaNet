...
#model.load_weights('new_weights/MA/CNN/weights.03-0.1173.hdf5',by_name=True)
##VGG
#from networks.VGG import VGG16
#model = VGG16((160,192,160,1))
#model.load_weights('new_weights/MA/VGG/weights.17-0.1877.hdf5',by_name=True)
## ResNet
#from networks.ResNet import Resnet
#model =  Resnet((160,192,160,1))
#model.load_weights('new_weights/MA/ResNet/weights.04-0.1667.hdf5',by_name=True)
##GoogleNet
...
model.load_weights('new_weights/MA/MHCNN/weights.05-0.1129.hdf5',by_name=True)
import json
import xlwt
# 设置Excel编码
