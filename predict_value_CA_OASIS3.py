...
#model.load_weights('new_weights/CA/VGG/weights.23-0.0510.hdf5',by_name=True)
## ResNet
...
#model.load_weights('new_weights/CA/GoogleNet/weights.13-0.0629.hdf5',by_name=True)
##MHCNN
from networks.my_model import my_model_single
model = my_model_single((160,192,160,1))
model.load_weights('new_weights/CA/MHCNN/weights.02-0.0890.hdf5',by_name=True)
import json
