...
##
weights_path = "new_weights/MA/MHCNN_kf10_10/"
weights_file = open('new_weights/MA/MHCNN_kf10_10/weights.txt')
...
for i in range(0,len(weights_strings)):
    ...
    image_strings,y_CDR = Random(image_strings,train_CDR,p_M_valid,p_A_valid)
    y_CDR[y_CDR==1]=0
    y_CDR[y_CDR==2]=1
    predicts = []
    ...
    print(ADNI_metric)
    write_excel_xls_append('new_predicts/MHCNN/KV10/MA.xls', ADNI_metric)
