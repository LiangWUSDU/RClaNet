...
def generator_data(train_moving_image_file, st):
    ...
    return moving_image,fixed_image,location,affine0
...
def gen_patch(moving_image, fixed_image,location):
     ...
     return moving_image_patch,fixed_image_patch,location_patch
...
def Random_image(moving_image_patch,fixed_image_patch,moving_image_patch_position):
    ...
    return moving_image_patch,fixed_image_patch,moving_image_patch_position

def baseline_huber_SAM_position_gen(train_moving_image_file,train_moving_image_txt,y_status,batch_size,batch_patch_size):
    while True:
        ...
        for start in range(0, len(image_strings), batch_size):
            ...
            for id in range(start, end):
                ...
                moving_image, fixed_image,  location,affine0 = generator_data(train_moving_image_file, st)
                moving_image_patch, fixed_image_patch,moving_image_patch_position = gen_patch( moving_image,fixed_image, location)
                moving_image_patch, fixed_image_patch,moving_image_patch_position = Random_image(moving_image_patch,fixed_image_patch,moving_image_patch_position)
                for start in range(0, len(moving_image_patch), batch_patch_size):
                    ...
                    yield ([moving_image_batch_patch, fixed_image_batch_patch,position],
