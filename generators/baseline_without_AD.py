...
def baseline_gen(train_moving_image_file,train_moving_image_txt,y_status,batch_size,batch_patch_size):
    while True:
            ...
            for id in range(start, end):
                ...
                for start in range(0, len(moving_image_patch), batch_patch_size):
                    ...
                    yield ([moving_image_batch_patch, fixed_image_batch_patch],
                          [flow,fixed_image_batch_patch,fixed_image_batch_patch,fixed_image_batch_patch,fixed_image_batch_patch])
