...
def propose_without_AD_gen(train_moving_image_file,train_moving_image_txt,train_moving_mask_file,train_moving_mask_txt,train_moving_boundary_file,y_status,batch_size,batch_patch_size):
    while True:
            ...
            for id in range(start, end):
                ...
                for start in range(0, len(moving_image_patch), batch_patch_size):
                    ...
                    yield ([moving_image_batch_patch, fixed_image_batch_patch,position,moving_mask_batch_patch,fixed_mask_batch_patch,moving_boundary_batch_patch,fixed_boundary_batch_patch],
                          [flow,fixed_image_batch_patch,fixed_image_batch_patch,fixed_image_batch_patch,fixed_image_batch_patch,y_true,y_true,y_true,y_true,y_true,y_true,y_true,y_true])
