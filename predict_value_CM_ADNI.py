...
#model.load_weights('new_weights/CM/CNN/weights.04-0.1767.hdf5',by_name=True)
##VGG
#from networks.VGG import VGG16
#model = VGG16((160,192,160,1))
#model.load_weights('new_weights/CM/VGG/weights.14-0.3649.hdf5',by_name=True)
## ResNet
...
#model.load_weights('new_weights/CM/GoogleNet/weights.07-0.2743.hdf5',by_name=True)
##MHCNN
from networks.my_model import my_model_single
model = my_model_single((160,192,160,1))
model.load_weights('new_weights/CM/MHCNN/weights.04-0.2647.hdf5',by_name=True)
import xlwt
